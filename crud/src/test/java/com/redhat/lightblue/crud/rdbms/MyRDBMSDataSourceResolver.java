...
/**
* Created by lcestari on 12/31/14.
*/
class MyRDBMSDataSourceResolver implements RDBMSDataSourceResolver {
    ...
    private class MyDS implements DataSource {
        @Override
        public Connection getConnection() throws SQLException {
            return new MyDS.MyCon();
        }
        ...
        private class MyCon implements Connection {
            @Override
            ...
            private class MyPre implements PreparedStatement {
                @Override
